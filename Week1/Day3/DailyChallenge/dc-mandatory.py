...
class Farm:
    ...
    def get_short_info(self):
        ...
        if len(names) > 1:
            animals_str = ", ".join(names[:-1]) + " and " + names[-1]
        else:
            animals_str = names[0]
...
# Step 8: add multiple animals at once via **kwargs
other_farm = Farm("Smith")
other_farm.add_animal(cow=5, sheep=2, goat=12)
print(other_farm.get_info())
print(other_farm.get_short_info())
