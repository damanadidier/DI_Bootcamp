...
# Run your code.
name = "Koffi Damana Alexis Didier"
age = 38
shoe_size = 43.5
...
if user_name == my_name:
    print(f"Wow, we have the same name! That's awesome, {user_name}!")
else:
    print(f"Nice to meet you, {user_name}! Your name is different from mine, but that's what makes it special!")
