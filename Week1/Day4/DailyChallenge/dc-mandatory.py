...
class Pagination:
    def __init__(self, items=None, page_size=10):
        ...
        self.current_idx = 0
        self.total_pages = max(1, math.ceil(len(self.items) / page_size))
...
# go_to_page with out-of-range values — try/except is necessary here because
# the method raises ValueError per the spec, and we want the test to keep running.
try:
    p.go_to_page(10)
    print(p.current_idx + 1)
