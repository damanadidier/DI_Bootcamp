...
# Dog class is defined above in this file; in a separate file you would: from xp_mandatory import Dog
import random
    ...
    def check_majority(self, first_name):
        for member in self.members:
            if member.first_name == first_name:
                ...
                return
        print(f"No member named {first_name} found in the {self.last_name} family.")
...
smith_family.born("Emma", 20)
smith_family.born("Liam", 15)
